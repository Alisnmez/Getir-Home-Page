...
function MobileApp() {
  return (
    <div className='container mx-auto bg-mobile-app bg-brand-color flex justify-between items-center mt-6 rounded-lg text-white'>
      ...
      <picture className='pt-6'>
        <img src="https://cdn.getir.com/getirweb-images/common/landing/phoneLanding.png" alt="mobil" />
        </picture>
    </div>
  )
}
